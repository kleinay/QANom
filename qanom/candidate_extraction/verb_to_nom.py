...
class SuffixBasedNominalizationCandidates:
    ...
    def __init__(self, verb_seed=infinitives):
        ...
        # initialize the deverbl-pairs list
        self._nom_verb_pair_list = self.generate_deverbal_pairs()

        # initialize the dict
        self._affixes_based_nom_dict = self.generate_deverbal_dict(multipleEntriesPerNom=True)
    ...
    def generate_deverbal_dict(self, multipleEntriesPerNom=False):
        """
        Returns:
...
if __name__ == '__main__':
    ...
    print(f'source verb for "devlopment": {vtn.get_source_verbs("development")}')